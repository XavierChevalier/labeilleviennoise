    ...
    <section className="bg-white dark:bg-gray-900">
      <article className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 prose lg:prose-xl">
        ...
        <p>
          ...
          <a href="https://labeilleviennoise.com/">
            https://labeilleviennoise.com/
          </a>{' '}
        ...
        <p>
          ...
          <br />
          <strong>Responsable publication</strong> : Anne-Marie Sueur –
          labeilleviennoise@gmail.com
          <br />
          Le responsable publication est une personne physique ou une personne
          morale.
          <br />
          <strong>Développeurs</strong> : Jeeves Studio – webmaster@email.com &
          Nicolas Chevalier - chevalier.nicolas2103+av@gmail.com
          <br />
          ...
          Sueur – labeilleviennoise@gmail.com
          <br />
        </p>
        <h2>
        ...
        <p>
          ...
          les dates et heures de l’intervention. Les mentions légales peuvent
