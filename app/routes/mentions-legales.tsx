export default function MentionsLegales() {
  ...
  const website = (
    <a href="https://labeilleviennoise.com/">https://labeilleviennoise.com/</a>
  )

  return (
    <section className="bg-white dark:bg-gray-900">
      <article className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 prose lg:prose-xl">
        <h1 className="text-primary text-center">Mentions légales</h1>
        <h2>Définitions</h2>
        <p>
          ...
          {website} met à disposition des Clients :
        </p>
        <p>
        ...
        <p>
          ...
          d’être détenues par {website} pour la gestion de votre compte, de la
        ...
        <p>
          ...
          du site internet {website} l'identité des différents intervenants dans
          le cadre de sa réalisation et de son suivi:
        </p>
        <p>
          <strong>Propriétaire</strong> : Micro-entrepreneur L'Abeille Viennoise
          – 2 rue Emile Romanet 38200 Vienne
          <br />
          <strong>Responsable publication</strong> : Anne-Marie Sueur – {email}
          <br />
          Le responsable publication est une personne physique ou une personne
          morale.
          <br />
          <strong>Développeurs</strong> : Jeeves Studio –
          chevalierxavier38+abeilleviennoise@gmail.com & Nicolas Chevalier -
          chevalier.nicolas2103+av@gmail.com
          <br />
          <strong>Hébergeur</strong> : Netlify, Inc. – 44 Montgomery Street,
          Suite 300, San Francisco, California 94104 - support@netlify.com
          <br />
          <strong>Délégué à la protection des données</strong> : Anne-Marie
          Sueur – {email}
          <br />
        </p>
        <h2>
        ...
        <p>
          L’utilisation du site {website} implique l’acceptation pleine et
          ...
          complétées à tout moment, les utilisateurs du site {website} sont donc
        ...
        <p>
          ...
          peut être toutefois décidée par {website}, qui s’efforcera alors de
          communiquer préalablement aux utilisateurs les dates et heures de
          l’intervention. Les mentions légales peuvent être modifiées à tout
        ...
        <p>
          Le site internet {website} a pour objet de fournir une information
          concernant l’ensemble des activités de la société.
          {website} s’efforce de fournir sur le site {website} des informations
        ...
        <p>
          Toutes les informations indiquées sur le site {website} sont données à
          titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les
          renseignements figurant sur le site {website} ne sont pas exhaustifs.
        ...
        <p>
          {website} et l’hébergeur ne pourront être tenus responsables en cas de
        ...
        <p>
          {website} est propriétaire des droits de propriété intellectuelle et
          ...
          vidéos, icônes et sons. Toute reproduction, représentation,
          ...
          sauf autorisation écrite préalable de : {website}.
        </p>
        <p>
        ...
        <p>
          {website} agit en tant qu’éditeur du site. {website} est responsable
          de la qualité et de la véracité du contenu qu’il publie.
        </p>
        <p>
          {website} ne pourra être tenu responsable des dommages directs et
          indirects causés au matériel de l’utilisateur, lors de l’accès au site
          internet {website}, et résultant soit de l’utilisation d’un matériel
          ne répondant pas aux spécifications indiquées au point 4, soit de
          l’apparition d’un bug ou d’une incompatibilité.
        </p>
        <p>
          {website} ne pourra également être tenu responsable des dommages
          indirects (tels par exemple qu’une perte de marché ou perte d’une
          chance) consécutifs à l’utilisation du site {website}. Des espaces
          interactifs (possibilité de poser des questions dans l’espace contact)
          sont à la disposition des utilisateurs. {website} se réserve le droit
          ...
          Le cas échéant, {website} se réserve également la possibilité de
        ...
        <p>
          ...
          le responsable du traitement des Données Personnelles est : L'Abeille
          Viennoise. {website}
          est représenté par Anne-Marie Sueur, son représentant légal
        </p>
        <p>
          En tant que responsable du traitement des données qu’il collecte,{' '}
          {website} s’engage à respecter le cadre des dispositions légales en
          ...
          {website} traite des Données Personnelles, {website} prend toutes les
        ...
        <p>{website} est susceptible de traiter tout ou partie des données :</p>
        <ul>
          <li>
          ...
          <li>
            pour mener des enquêtes de satisfaction facultatives sur {website} :
            adresse email
          </li>
          <li>
        ...
        <p>
          {website} ne commercialise pas vos données personnelles qui sont donc
        ...
        <p>
          ...
          Utilisateurs de {website} disposent des droits suivants :
        </p>
        <ul>
          <li>
          ...
          <li>
            ...
            mort et de choisir à qui {website} devra communiquer (ou non) ses
            données à un tiers qu’ils aura préalablement désigné
          </li>
        </ul>
        <p>
          Dès que {website} a connaissance du décès d’un Utilisateur et à défaut
          d’instructions de sa part, {website} s’engage à détruire ses données,
          sauf si leur conservation s’avère nécessaire à des fins probatoires ou
          pour répondre à une obligation légale.
        </p>
        <p>
          Si l’Utilisateur souhaite savoir comment {website} utilise ses Données
          Personnelles, demander à les rectifier ou s’oppose à leur traitement,
          l’Utilisateur peut contacter {website} par écrit à l’adresse suivante
          :
        </p>
        L'Abeille Viennoise – DPO, Anne-Marie Sueur
        <br />2 rue Emile Romanet, 38200 Vienne.
        <p>
          Dans ce cas, l’Utilisateur doit indiquer les Données Personnelles
          qu’il souhaiterait que {website} corrige, mette à jour ou supprime, en
        ...
        <p>
          ...
          aux obligations qui sont imposées à {website} par la loi, notamment en
          matière de conservation ou d’archivage des documents. Enfin, les
          Utilisateurs de {website} peuvent déposer une réclamation auprès des
          autorités de contrôle, et notamment de la CNIL
          (https://www.cnil.fr/fr/plaintes).
        </p>
        <h3>7.4 Non-communication des données personnelles</h3>
        <p>
          {website} s’interdit de traiter, héberger ou transférer les
          ...
          autant, {website} reste libre du choix de ses sous-traitants
          techniques et commerciaux à la condition qu’il présentent les
          garanties suffisantes au regard des exigences du Règlement Général sur
          la Protection des Données (RGPD : n° 2016-679).
        </p>
        <p>
          {website} s’engage à prendre toutes les précautions nécessaires afin
          de préserver la sécurité des Informations et notamment qu’elles ne
          ...
          Informations du Client est portée à la connaissance de {website},
          celle-ci devra dans les meilleurs délais informer le Client et lui
          communiquer les mesures de corrections prises. Par ailleurs {website}{' '}
          ne collecte aucune « données sensibles ».
        </p>
        <p>
          Les Données Personnelles de l’Utilisateur peuvent être traitées par
          des filiales de {website} et des sous-traitants (prestataires de
        ...
        <p>
          ...
          accès aux données des Utilisateurs de {website} sont principalement
        ...
        <p>
          Aucune information personnelle de l'utilisateur du site {website}{' '}
          ...
          rachat de {website} et de ses droits permettrait la transmission des
        ...
        <p>
          Le site {website} contient un certain nombre de liens hypertextes vers
          d’autres sites, mis en place avec l’autorisation de {website}.
          Cependant, {website} n’a pas la possibilité de vérifier le contenu des
        ...
        <p>
          {website} est susceptible de traiter les informations de l’Utilisateur
          concernant sa visite du Site, telles que les pages consultées, les
          recherches effectuées. Ces informations permettent à {website}{' '}
        ...
        <p>
          ...
          soit susceptible d’être enregistré dans son terminal. {website}{' '}
        ...
        <p>
          ...
          être le cas lorsque {website} ou l’un de ses prestataires ne peut pas
        ...
        <p>
          Le cas échéant, {website} décline toute responsabilité pour les
          conséquences liées au fonctionnement dégradé du Site et des services
          éventuellement proposés par {website}, résultant (i) du refus de
          Cookies par l’Utilisateur (ii) de l’impossibilité pour {website}{' '}
        ...
        <p>
          ...
          modifier ses souhaits en matière de Cookies. {website} pourra en outre
        ...
        <p>
          {website} peut employer occasionnellement des balises Internet
        ...
        <p>
          Cette technologie permet à {website} d’évaluer les réponses des
          visiteurs face au Site et l’efficacité de ses actions (par exemple, le
          nombre de fois où une page est ouverte et les informations
        ...
        <p>
          ...
          l’attention de {website}, et fournir d’autres services relatifs à
          l’utilisation de celui-ci et d’Internet.
        </p>
        <h2>10. Droit applicable et attribution de juridiction.</h2>
        <p>
          Tout litige en relation avec l’utilisation du site {website} est
          ...
          compétents de Ville du tribunal de compétence en cas de litige
        </p>
      </article>
    </section>
  )
