  ...
  return (
    <article className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 prose lg:prose-xl">
      ...
      <p>
        ...
        détenues par {website} pour la gestion de votre compte, de la gestion de
      ...
      <p>
        ...
        site internet {website} l'identité des différents intervenants dans le
      ...
      <p>
        ...
        <br />
        <strong>Hébergeur</strong> : Netlify, Inc. – 44 Montgomery Street, Suite
        300, San Francisco, California 94104 - support@netlify.com
        <br />
        <strong>Délégué à la protection des données</strong> : Anne-Marie Sueur
        – {email}
        <br />
      </p>
      <h2>
      ...
      <p>
        L’utilisation du site {website} implique l’acceptation pleine et entière
        ...
        moment, les utilisateurs du site {website} sont donc invités à les
      ...
      <p>
        ...
        être toutefois décidée par {website}, qui s’efforcera alors de
      ...
      <p>
        {website} agit en tant qu’éditeur du site. {website} est responsable de
      ...
      <p>
        ...
        internet {website}, et résultant soit de l’utilisation d’un matériel ne
      ...
      <p>
        ...
        sont à la disposition des utilisateurs. {website} se réserve le droit de
        ...
        cas échéant, {website} se réserve également la possibilité de mettre en
      ...
      <p>
        ...
        responsable du traitement des Données Personnelles est : L'Abeille
        Viennoise. {website}
      ...
      <p>
        ...
        traitements conforme à la réalité. Chaque fois que {website} traite des
        Données Personnelles, {website} prend toutes les mesures raisonnables
      ...
      <p>
        ...
        de {website} disposent des droits suivants :
      </p>
      <ul>
        <li>
        ...
        <li>
          ...
          et de choisir à qui {website} devra communiquer (ou non) ses données à
      ...
      <p>
        ...
        souhaiterait que {website} corrige, mette à jour ou supprime, en
      ...
      <p>
        ...
        obligations qui sont imposées à {website} par la loi, notamment en
      ...
      <p>
        {website} s’interdit de traiter, héberger ou transférer les Informations
        ...
        sans en informer préalablement le client. Pour autant, {website} reste
      ...
      <p>
        {website} s’engage à prendre toutes les précautions nécessaires afin de
        ...
        Client est portée à la connaissance de {website}, celle-ci devra dans
        les meilleurs délais informer le Client et lui communiquer les mesures
        de corrections prises. Par ailleurs {website} ne collecte aucune «
        données sensibles ».
      </p>
      <p>
        Les Données Personnelles de l’Utilisateur peuvent être traitées par des
        filiales de {website} et des sous-traitants (prestataires de services),
      ...
      <p>
        ...
        accès aux données des Utilisateurs de {website} sont principalement les
      ...
      <p>
        Aucune information personnelle de l'utilisateur du site {website} n'est
        ...
        {website} et de ses droits permettrait la transmission des dites
        ...
        de l'utilisateur du site {website}.
      </p>
      <h3>Sécurité</h3>
      <p>
        Pour assurer la sécurité et la confidentialité des Données Personnelles
        et des Données Personnelles de Santé, {website} utilise des réseaux
      ...
      <p>
        ...
        d’être enregistré dans son terminal. {website} informe l’Utilisateur
      ...
      <p>
        ...
        éventuellement proposés par {website}, résultant (i) du refus de Cookies
        par l’Utilisateur (ii) de l’impossibilité pour {website} d’enregistrer
      ...
      <p>
        ...
        {website}, et fournir d’autres services relatifs à l’utilisation de
        celui-ci et d’Internet.
      </p>
      <h2>10. Droit applicable et attribution de juridiction.</h2>
      <p>
        Tout litige en relation avec l’utilisation du site {website} est soumis
        ...
        Ville du tribunal de compétence en cas de litige
      </p>
    </article>
  )
}
